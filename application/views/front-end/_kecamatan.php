      ...
      <div class="col-sm-8 content">
        <div class="panel">
          <div class="panel-heading">
            <h3 class="panel-title">Daftar Kecamatan</h3>
          </div>
              ...
              <tbody>
                ...
                foreach ($la->result() as $r) { ?>
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-success btn-sm btn-flat" href="<?= base_url() . 'web/kecamatandetail/' . $r->id ?>"><i class="fa fa-map-o"></i> View Map</a>
                      </div>
                    </td>
                  </tr>
                <?php $no++;
