      <div class="col-sm-4 sidebar">
        <div class="panel">
          <div class="panel-heading">
            <h3 class="panel-title">List Lokasi Investasi</h3>
          </div>
        ...
        <div class="panel">
          <div class="panel-heading">
            <h3 class="panel-title">List Kecamatan</h3>
          </div>
          <div class="panel-body">
            <?php foreach ($c->result() as $r) { ?>
              <blockquote style="padding:0 10px;">
                <p><?= $r->nama ?></p>
                <footer><?= $r->alamat ?> <cite title="Source Title"><?= $r->telp ?></cite></footer>
              </blockquote>
            <?php } ?>
            <a class="btn btn-warning btn-flat" style="float:right;" href="<?= base_url() . 'web/kecamatan' ?>"><i class="fa fa-eye"></i> View all location</a>
          </div>
