        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="box box-success">
              ...
              <!-- /.box-header -->
              <?= form_open_multipart('dashboard/Kecamatan_kategori') ?>
              <div class="box-body">
                  ...
                  <tbody>
                    ...
                    foreach ($k->result() as $r) { ?>
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-success btn-sm btn-flat" href="<?= base_url() . 'dashboard/kecamatan_kategori_edit/' . $r->id ?>"><i class="fa fa-edit"></i> </a>
                            <a class="btn btn-danger btn-sm btn-flat" href="<?= base_url() . 'dashboard/kecamatan_kategori_delete/' . $r->id ?>"><i class="fa fa-trash"></i> </a>
                          </div>
                        </td>
                      </tr>
                    <?php $no++;
