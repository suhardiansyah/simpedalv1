          ...
          <div class="col-md-12">
            <div class="box box-success">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Telepon</label>
                  <input name="telp" type="text" class="form-control" placeholder="Telephon" required="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input name="modal" type="text" class="form-control" placeholder="Rp.500.000.000,-" required="">
                </div>
              </div>
              <!-- /.box-body -->
